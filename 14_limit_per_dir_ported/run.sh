...
GOOS=linux GOARCH=amd64 go build limit.go
mv limit limit.linux
GOOS=darwin GOARCH=arm64 go build limit.go
mv limit limit.mac.m1
GOOS=darwin GOARCH=amd64 go build limit.go
mv limit limit.mac.intel
