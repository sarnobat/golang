...
cat /Volumes/git/mwk.git/snippets/*mwk | perl -pe 's{\b}{\n}g' | /Volumes/git/github/2024/golang/26_stopword_remover/stopwordrm | /Volumes/git/github/2024/golang/27_stemmer_lemmatizer/lemmatize 2> /dev/null | sort | uniq -c | sort -n
